...
ActiveRecord::Schema.define(version: 2018_09_03_222452) do
  ...
  create_table "feab_elements", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["type"], name: "index_feab_elements_on_type"
  end

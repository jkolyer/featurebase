...
Features are associated with a given <i>Role</i> and <i>Domain</i>.  Role describe the type of user acting on your system; domains group your features along functional lines.  
